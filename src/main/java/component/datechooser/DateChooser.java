...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new component.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new component.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new component.datechooser.Button();
        cmdPrevious = new component.datechooser.Button();
        slide = new component.datechooser.Slider();
    ...
    private component.datechooser.Button cmdForward;
    private component.datechooser.Button cmdMonth;
    private component.datechooser.Button cmdPrevious;
    private component.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private component.datechooser.Slider slide;
