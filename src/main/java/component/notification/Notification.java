...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            ...
            lbIcon.setIcon(ImageUtil.read(getClass().getResource("/icon/notification/sucess.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(ImageUtil.read(getClass().getResource("/icon/notification/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(ImageUtil.read(getClass().getResource("/icon/notification/close.png"))); // NOI18N
