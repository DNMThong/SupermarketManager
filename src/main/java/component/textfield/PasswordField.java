...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = ImageUtil.read(getClass().getResource("/icon/textfield/eye.png")).getImage();
        eye_hide = ImageUtil.read(getClass().getResource("/icon/textfield/eye_hide.png")).getImage();
