...
public class DanhSachPhieuNhapJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ChiTietPhieuNhapDialog = new JDialog();
        ...
        jLabel2 = new JLabel();
        jLabel4 = new JLabel();
        lblMaPhieuNhap = new JLabel();
        lblNgayLapPhieuNhap = new JLabel();
        jLabel5 = new JLabel();
        ...
        tblChiTietPhieuNhap.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        btnInPhieuNhap.setIcon(ImageUtil.read(getClass().getResource("/icon/Action-file-print-icon.png"))); // NOI18N
        ...
        btnXoaPhieuNhap.setIcon(ImageUtil.read(getClass().getResource("/icon/Delete-file-icon.png"))); // NOI18N
        ...
        btnExcel.setIcon(ImageUtil.read(getClass().getResource("/icon/Excel-icon.png"))); // NOI18N
    ...
    private JDialog ChiTietPhieuNhapDialog;
    ...
    private JLabel lblNgayLapPhieuNhap;
